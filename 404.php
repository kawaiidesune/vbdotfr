 ...
 */
?>
<?php VBDotFR_Utilities::get_template_parts( array( 'parts/shared/html-header', 'parts/shared/header' ) ); ?>
<div class="container-fluid">
	<div class="row">
		<div class="col-12">
			<h1 class="display-1"><?php _e("Looks like you're a little lost",'VBDotFR'); ?></h1>
		</div>
	</div>
	<div class="row">
		<div class="col-6">
			<p class="lead"><?php _e("This is what we call in the web industry, a 404 page. Usually, people only get here if they're lost. To find your way, you can use the search box in the navigation bar above or click a link above that seems like the most likely match for the place you wanted to go.", 'VBDotFR'); ?></p>
