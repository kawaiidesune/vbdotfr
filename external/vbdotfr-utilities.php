 ...
 * The main one that is used in VBDotFR is VBDotFR_Utilities::add_slug_to_body_class(), this will add the page or post slug to the body class
 *
 */
	 
class VBDotFR_Utilities {
	/**
